...
export default function page() {
    return (
        <div className="lg:px-[140px] pt-8 md:pt-[40px] bg-white">
            <div className="w-full bg-white ">

                {/* Header Section */}
                <div className="">
                    <h1 className="text-3xl md:text-4xl font-bold text-center mb-2 text-black">Privacy Policy</h1>
                </div>
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 mb-4 leading-relaxed">We may share your data with:</p>
